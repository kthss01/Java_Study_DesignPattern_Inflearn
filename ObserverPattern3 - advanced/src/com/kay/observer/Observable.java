...
public class Observable<T> {
	 ...
	 * observable object and {@code null}. In other words, this method is equivalent
	 * to: <blockquote>{@code
	 ...
	 * called automatically by the {@code notifyObservers} methods.
	 *
	 ...
	 *
	 * @return {@code true} if and only if the {@code setChanged} method has been
	 *         called more recently than the {@code clearChanged} method on this
